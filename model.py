...
co2 = sfc.CO2 * convert_CO2
co2.name = 'CO2'
co2_bg = sfc.CO2B * convert_CO2
co2_bg.name = 'CO2B'

# Eta 0.995
#eta995 = openall(files="2009*_co2_eta995.nc", format=nc)
#co2_eta995 = eta995.CO2 * convert_CO2
#co2_eta995.name = 'CO2'

# Eta 0.932
eta932 = openall(files="2009*_co2_eta932.nc", format=nc)
co2_eta932 = eta932.CO2 * convert_CO2
co2_eta932.name = 'CO2'

# Ocean field
co2_ocean = sfc.COC * convert_CO2
co2_ocean.name = 'COC'
...
co2_zonal = zonal.CO2 * convert_CO2
co2_zonal.name = 'CO2'
co2b_zonal = zonal.CO2B * convert_CO2
co2b_zonal.name = 'CO2B'
coc_zonal = zonal.COC * convert_CO2
coc_zonal.name = 'COC'
cla_zonal = zonal.CLA * convert_CO2
cla_zonal.name = 'CLA'
cbb_zonal = zonal.CBB * convert_CO2
cbb_zonal.name = 'CBB'
cff_zonal = zonal.CFF * convert_CO2
cff_zonal.name = 'CFF'
cons_zonal = zonal.CONS * convert_CO2
