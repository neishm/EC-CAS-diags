...
class CT_Data(DataProduct):
  ...
  field_list = (
    ('bg', 'CO2_background', '10E-6 mol mol(semidry_air)-1'),
    ('ff', 'CO2_fossil', '10E-6 mol mol(semidry_air)-1'),
    ('bio', 'CO2_bio', '10E-6 mol mol(semidry_air)-1'),
    ('ocean', 'CO2_ocean', '10E-6 mol mol(semidry_air)-1'),
    ('fires', 'CO2_fire', '10E-6 mol mol(semidry_air)-1'),
